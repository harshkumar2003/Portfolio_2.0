  ...
  const projects = [
    {
      ...
      category: "AI/ML",
      description:
        "Advanced neural network interface with real-time data visualization and machine learning capabilities.",
    ...
    },
    {
      ...
      category: "Data Viz",
      description: "Interactive quantum computing dashboard with complex data visualization and real-time monitoring.",
    ...
    },
    {
      ...
      category: "FinTech",
      description: "Modern cryptocurrency trading platform with advanced charting and portfolio management.",
      image: "/placeholder.svg?height=400&width=600",
